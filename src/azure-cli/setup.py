...
DEPENDENCIES = [
    ...
    'fabric~=2.4',  # only used in appservice
    'jsmin~=2.2.2',  # only used in resource
    'pytz==2019.1',  # not used
    'scp~=0.13.2',  # only used in acs
    'sshtunnel~=0.1.4',  # only used in acs
    'urllib3[secure]~=1.18',  # only used in appservice
    'vsts-cd-manager~=1.0.0,>=1.0.2',  # only used in appservice
    'websocket-client~=0.56.0',
    'xmltodict~=0.12', # only used in appservice
    'javaproperties==0.5.1',  # not used
    'jsondiff==1.2.0'  # not used
]
