...
api_base_url = "https://api.github.com/search/issues?q=repo:Azure/azure-cli+is:issue+state:open+created:%3E{}+sort:created-asc+-label:%22Service%20Attention%22"
days_before = 90
...
def generate_issue_report():
    ...
    issues_url = api_base_url.format(start_date_str)
...
def open_github_my_issues():
    import webbrowser
    github_base_url= "https://github.com/Azure/azure-cli/issues?utf8=%E2%9C%93&q=is%3Aissue+is%3Aopen+-created%3A%3C{}+sort%3Acreated-asc+assignee%3A%40me"
    today = datetime.date.today()
    start_date = today - datetime.timedelta(days=days_before)
    start_date_str = start_date.strftime(date_format)
    url = github_base_url.format(start_date_str)
